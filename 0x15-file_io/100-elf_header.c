...
/**
 * check_elf - A function checking if a file is an ELF file.
...
/**
 * print_data - Printing data of an ELF header.
 * @e_ident: points to an array containing the ELF class.
 */
void print_data(unsigned char *e_ident)
{
...
/**
 * print_abi - Printing ABI version of an ELF header.
 * @e_ident: points an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
